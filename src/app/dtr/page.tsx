    ...
    <div className="min-h-screen flex" style={{ backgroundColor: "#F8FAFC" }}>
      <aside className="w-60 flex-shrink-0 flex flex-col" style={{ backgroundColor: "#FFFFFF", borderRight: "1px solid #E2E8F0" }}>
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-1">
            ...
            <li><button onClick={() => router.push("/dtr")} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium" style={{ backgroundColor: "#00529B", color: "#FFFFFF" }}>DTR</button></li>
      ...
      <main className="flex-1 overflow-auto">
        <header className="px-8 py-4 flex items-center justify-between" style={{ backgroundColor: "#FFFFFF", borderBottom: "1px solid #E2E8F0" }}>
          <h2 className="text-lg font-bold" style={{ color: "#1E293B" }}>Daily Time Record (DTR)</h2>
          <div className="flex items-center gap-3">
        ...
        <div className="p-8">
          <div className="p-6 rounded-2xl" style={{ backgroundColor: "#FFFFFF", boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)' }}>
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold" style={{ color: "#1E293B" }}>DTR Overview</h3>
            ...
            {uploadedFile ? (
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-xl border" style={{ borderColor: "#E2E8F0", minHeight: "500px" }}>
                  <div className="flex items-center justify-center h-full" style={{ minHeight: "450px", color: "#64748B" }}>
                  ...
                  <div className="flex items-center justify-between pt-4">
                    ...
                    <button onClick={() => {
                      ...
                      setFileName("");
                      setIsUrgent(false);
                    }} className="px-4 py-2 rounded-xl text-sm font-medium" style={{ backgroundColor: "#16A34A", color: "white" }}>Submit DTR</button>
                  </div>
              </div>
            ) : (
              <div className="p-12 rounded-xl border-dashed border-2 flex flex-col items-center justify-center" style={{ borderColor: "#E2E8F0" }}>
                ...
                <p className="text-sm font-medium mb-2" style={{ color: "#1E293B" }}>Upload your Daily Time Record</p>
